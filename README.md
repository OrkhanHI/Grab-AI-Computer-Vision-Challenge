...
<br><br>
<b>*In order to upload test images from Stanford repository *Preprocess-Test.ipynb* file need to be run which will create Test folder with images and bounding boxes provided from Stanford web-page.*</b><br>
